...
A searchable educational database connecting common symptoms to nutrition, lifestyle factors, food sources, and supplement safety guidance — for health consultants and the general public.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "268115960+mysovera-ui@users.noreply.github.com"
  git config user.name "mysovera-ui"
  ```
